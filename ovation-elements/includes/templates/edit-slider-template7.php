        ...
        <div class="row content-row">
            ...
            <div class="col-md-6">
                <div class="content text-center">
                    ...
                    The Travel Slider Template is a dynamic and professional design tool perfect for creating visually stunning, interactive sliders for business websites. With customizable options for images, text, and calls-to-action, it helps businesses showcase their services, portfolio, or announcements effectively.
                    </p>
                    <div class="buttons">
...
<!-- live preview -->
<div class="modal fade modal-temp-7" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="oe-travel-slider-content-main-box oe-travel-slider-main-box_travel_tour" style="background:url('<?php echo esc_url($right_bg_image) ?>')">
    
    <div class="row position-relative content_outer_row">

      <div class="col-xl-5 col-lg-6 col-md-6 pe-0">
        <div class="oe-travel-slider-post-bg-image" style="background-repeat: no-repeat; background-size: 100% auto; background-position: center; background-image: url(<?php echo esc_url(OVA_ELEMS_URL . 'assets/images/image1.png'); ?>);">
            
            <div class="oe-travel-slider-post-bg-bg-box d-flex justify-content-md-start justify-content-sm-center justify-content-center align-items-center">
            ...
            <div class="oe-travel-slider-post-banner-outer-box">
              <div class="oe-travel-slider-post-banner-heading-box">
                <h1 class="oe-travel-slider-post-banner-main-head text-start">France Tour</h1>
              </div>
              <p class="oe-travel-slider-post-banner-sec-para text-start">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been</p>

              <p class="oe-travel-slider-post-banner-schedule-text text-start">Next Tour : 01-01-2025 To 08-01-2025 (08 Day & Night)</p>

              <div class="d-flex gap-md-4 gap-sm-2 gap-2 align-items-center oe-travel-slider-banner-btn-box pt-3">
                <a class="oe-travel-slider-explore-btn" href="#">Explore More</a>   
                <a class="oe-travel-slider-video-btn myVideoBtns" data-url="" href="#myModal1" id="myBtn1">
        ...
        <div class="oe-travel-slider-banner-custom-box">
           <div class="oe-travel-slider-banner-content-box">
            ...
            <div class="d-flex flex-column gap-2 oe-travel-slider-banner-content-main">
                   <div class="ovtraveltittle d-flex justify-content-md-start justify-content-sm-start justify-content-start align-items-center">
                      ...
                      <span class="oe-travel-slider-sub-head">Welcome My Travel Agency</span>
                  </div>
                 <div class="oe-travel-slider-banner-heading-box">
                     <h1 class="oe-travel-slider-banner-main-head text-start">Find Next Place To Visit</h1>
                </div>
              <p class="oe-travel-slider-banner-sec-para text-start">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>

              <div class="oe-travel-slider-banner-btn-box d-flex gap-md-4 gap-sm-2 gap-2 align-items-center pt-3">
        ...
        <div class="col-xxl-3 col-xl-3 col-lg-4 col-sm-6 col-12 align-self-end mb-sm-0 mb-3">
          <div class="row oe-travel-slider-post-content-inner-box">
              ...
              <div class="oe-travel-slider-review-text text-sm-start text-center align-self-center">
                   <div class="icon">
                       <img src="<?php echo isset($static_settings['ov_client_image']) ? esc_url($static_settings['ov_client_image']) : ''; ?>" alt="">
                   </div>
                   <div class="content">
          ...
          <div class="col-xxl-8 col-xl-8 col-lg-8 col-sm-6 col-12">
            <div class="row">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12 oe-travel-slider-carousel-post-boxes" >
                  ...
                  <div class="oe-travel-slider-carousel-post-bg-image" style="border-radius:12px;background-size: 100% auto;background-position: center;background-image: url(<?php echo esc_url(OVA_ELEMS_URL . 'assets/images/image1.png'); ?>);"> 
                    <div class="oe-travel-slider-carousel-post-box">
                      <div class="oe-travel-slider-carousel-post">
                        <div class="oe-travel-slider-carousel-post-bg-bg-box d-flex justify-content-md-start justify-content-sm-center justify-content-center align-items-center">
                          <span class="oe-travel-slider-carousel-post-icon-img me-2 ms-0 position-relative">
                            <div class="oe-travel-slider-carousel-post-icon">
                                <img src="" alt="">
                            </div>
                          </span>                      
                          <span class="oe-travel-slider-carousel-post-sub-head">Jackson Lawrence</span>
                        </div>

                        <div class="oe-travel-slider-carousel-post-banner-outer-box oe-travel-slider-carousel-post-banner-outer-box_hover">
                          <div class="oe-travel-slider-carousel-post-banner-heading-box">
                            <h1 class="oe-travel-slider-carousel-post-banner-main-head">France Tour</h1>
                          </div>
                          <p class="oe-travel-slider-carousel-post-banner-sec-para">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                   ...
                   <div class="slide-container mb-4 p-3 border rounded" data-index="<?php echo esc_attr($index); ?>">
                       <div class="row">
                           ...
                           <div class="col-md-12 form-group">
                               ...
                               <select id="select_post_<?php echo esc_attr($index); ?>" name="selected_posts[]" class="form-control">
                                   <?php
                           ...
                           <div class="col-md-6 form-group">
                               ...
                               <input type="text" id="button_text_<?php echo esc_attr($index); ?>" name="button_data[<?php echo esc_attr($index); ?>][text]" class="form-control" value="<?php echo esc_attr($button_data[$index]['text'] ?? ''); ?>" />
                           </div>
                           <div class="col-md-6 form-group">
                               <label for="button_url_<?php echo esc_attr($index); ?>">Button URL</label>
                               <input type="url" id="button_url_<?php echo esc_attr($index); ?>" name="button_data[<?php echo esc_attr($index); ?>][url]" class="form-control" value="<?php echo esc_url($button_data[$index]['url'] ?? ''); ?>" />
                           </div>
   
                           <!-- Additional fields (Button2, Tour Info) -->
                           <div class="col-md-6 form-group">
                               <label for="button2_text_<?php echo esc_attr($index); ?>">Button2 Text</label>
                               <input type="text" id="button2_text_<?php echo esc_attr($index); ?>" name="button_data[<?php echo esc_attr($index); ?>][text2]" class="form-control" value="<?php echo esc_attr($button_data[$index]['text2'] ?? ''); ?>" />
                           </div>
                           <div class="col-md-6 form-group">
                               <label for="button2_url_<?php echo esc_attr($index); ?>">Button2 URL</label>
                               <input type="url" id="button2_url_<?php echo esc_attr($index); ?>" name="button_data[<?php echo esc_attr($index); ?>][url2]" class="form-control" value="<?php echo esc_url($button_data[$index]['url2'] ?? ''); ?>" />
                           </div>
                           <div class="col-md-12 form-group">
                               <label for="tour_info_<?php echo esc_attr($index); ?>">Tour Info</label>
                               <textarea id="tour_info_<?php echo esc_attr($index); ?>" name="tour_info_data[<?php echo esc_attr($index); ?>]" class="form-control"><?php echo esc_html($tour_info_data[$index] ?? ''); ?></textarea>
                           </div>

                           <!-- Video Upload Field -->
                           <div class="col-md-12 form-group">
                                <label for="uploaded_video_<?php echo esc_attr($index); ?>">Upload Video</label>
                                <input type="text" id="uploaded_video_<?php echo esc_attr($index); ?>" name="video_data[<?php echo esc_attr($index); ?>][upload_video]" class="form-control video-upload-url" value="<?php echo esc_url($video_data[$index]['upload_video'] ?? ''); ?>" />
                                <button type="button" class="button video-upload-btn" data-target="uploaded_video_<?php echo esc_attr($index); ?>">Upload</button>
                            </div>
               ...
               <div class="slide-container mb-4 p-3 border rounded" data-index="0">
                   <div class="row">
                       ...
                       <div class="col-md-6 form-group">
                           ...
                           <input type="text" id="button_text_0" name="button_data[0][text]" class="form-control" />
                       </div>
                       <div class="col-md-6 form-group">
                           <label for="button_url_0">Button URL</label>
                           <input type="url" id="button_url_0" name="button_data[0][url]" class="form-control" />
                       </div>
   
                       <!-- Additional fields (Button2, Tour Info) -->
                       <div class="col-md-6 form-group">
                           <label for="button2_text_0">Button2 Text</label>
                           <input type="text" id="button2_text_0" name="button_data[0][text2]" class="form-control" />
                       </div>
                       <div class="col-md-6 form-group">
                           <label for="button2_url_0">Button2 URL</label>
                           <input type="url" id="button2_url_0" name="button_data[0][url2]" class="form-control" />
                       </div>
                       <div class="col-md-12 form-group">
                           <label for="tour_info_0">Tour Info</label>
                           <textarea id="tour_info_0" name="tour_info_data[0]" class="form-control"></textarea>
                       </div>
                       <!-- for upload vedio -->
                      <!-- Upload Video Field with Upload Button -->
                      <div class="col-md-12 form-group">
                          <label for="uploaded_video_0">Upload Video</label>
                          <input type="text" id="uploaded_video_0" name="video_data[0][upload_video]" class="form-control video-upload-url" />
                          <button type="button" class="button video-upload-btn" data-target="uploaded_video_0">Upload</button>
                      </div>
        ...
        <!-- slider end -->
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                      ...
                      <small class="form-text text-muted">Ex :(xyz Followers[Educate Followers] , Follow us , subscribe ).</small>
                ...
                <div class="col-md-4 form-group d-flex align-items-center">
                    ...
                    <button type="button" class="upload_image_button button button-secondary" id="upload_minheadimage_button">Upload Image</button>
                    <div class="upload-wrapper">
                        ...
                        <img id="upload_minheadimage_preview" src="<?php echo isset($static_settings['upload_minheadimage']) ? esc_url($static_settings['upload_minheadimage']) : ''; ?>" 
                ...
                <div class="col-md-4 form-group ">
                    ...
                    <input type="text" id="ov_travel_head_tag" name="ov_travel_head_tag" class="form-control" 
                ...
                <div class="col-md-4 form-group d-flex align-items-center">
                    ...
                    <button type="button" class="upload_image_button button upload-image-button ml-2">Upload Image</button>
                    <div id="ov_client_image_preview" style="margin-top: 10px;">
                        <?php if (!empty($static_settings['ov_client_image'])): ?>
                            <img src="<?php echo esc_url($static_settings['ov_client_image']); ?>" alt="Client Image" id="ov_client_image_preview_img" style="max-width: 100px; max-height: 100px;">
                        <?php else: ?>
                            <img src="" alt="Client Image" id="ov_client_image_preview_img" style="display:none; max-width: 100px; max-height: 100px;">
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-md-4 form-group">
                    ...
                    <input type="number" id="title_head_font_size" name="title_head_font_size" class="form-control"
                  ...
                  <div class="col-md-4 form-group">
                      ...
                      <input type="number" id="oe_button_font_size" name="oe_button_font_size" class="form-control"
                ...
                <div class="col-md-4 form-group">
                    ...
                    <input type="number" id="ov_mini_title_right_font_size" name="ov_mini_title_right_font_size" class="form-control"
                ...
                <div class="col-md-4 form-group">
                    ...
                    <input type="number" id="ov_mini_description_font_size" name="ov_mini_description_font_size" class="form-control"
                ...
                <div class="col-md-4 form-group">
                     ...
                     <input type="number" id="thmhead_font_size" name="thmhead_font_size" class="form-control"
                ...
                <div class="col-md-4 form-group">
                     ...
                     <input type="number" id="thmbtitle_font_size" name="thmbtitle_font_size" class="form-control"
                ...
                <div class="col-md-4 form-group">
                     ...
                     <input type="number" id="thmbdesc_font_size" name="thmbdesc_font_size" class="form-control"
                ...
                <div class="form-group col-md-4 mini">
                       ...
                       <input type="number" id="ov_review_text_font_size" name="ov_review_text_font_size" class="form-control"
