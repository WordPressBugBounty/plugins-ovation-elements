...
<!-- live preview -->
<div class="modal fade modal-temp-2" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="oe-inner-wrap">
            ...
            <div class="oe-travel-banner-wrap">
                ...
                <div class="social-media-wrap">
                    ...
                    </div><div class="follow-title">Follow Us</div>
                    ...
                    <div class="banner-nav-top">
                        <div class="oe-travel-slider-inner-wrap">
                            <div class="oe-travel-nav-slide active">
                                <div class="nav-dot"><img src="" id="preview-slide-image" alt="Banner Image"></div>
                            ...
                            <div class="oe-travel-slider-content">
                                ...
                                <p class="banner-para" id="preview-mini-description2">Mini Description 2</p>
                            </div>
                ...
                <?php foreach ($slides as $index => $slide): ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <textarea id="slide_description_<?php echo esc_attr($index); ?>" name="slide_descriptions[]" 
                                rows="3" class="form-control" placeholder="Enter slide description"><?php echo esc_textarea($slide['description']); ?></textarea>
                        </div>
            ...
            <!-- slider end -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" id="ov_template_social_review_text" name="ov_template_social_review_text" class="form-control" 
                    ...
                    <div class="col-md-6 form-group d-flex gap-3 mini">
                        ...
                        <button type="button" id="ov-client-right-img" class="upload_corner_images_button button btn btn-info mt-2 upload_image_button">Upload Image:</button>
                    </div>
