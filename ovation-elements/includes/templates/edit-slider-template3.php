        ...
        <div class="row content-row">
            ...
            <div class="col-md-6">
                <div class="content text-center">
                    ...
                    The Ecommerce Slider Template is a dynamic and professional design tool perfect for creating visually stunning, interactive sliders for business websites. With customizable options for images, text, and calls-to-action, it helps businesses showcase their services, portfolio, or announcements effectively.
                    </p>
                    <div class="buttons">
...
<!-- live preview -->
<div class="modal fade modal-temp-3" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="slide-container mb-4 p-3 border rounded" data-index="0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group d-flex align-items-center">
                            ...
                            <img class="mr-2 ml-2" src="" style="max-width: 100px; max-height: 100px; display: none;" />
                            <button type="button" class="ml-2 upload_image_button button mt-2">Upload Image:</button>
                        </div>
                        ...
                        <div class="col-md-12 form-group"> 
                            ...
                            <input type="text" id="slide_head_tag_0" name="slide_head_tags[]" class="form-control" placeholder="Enter head tag" />
                        </div>
            ...
            <?php foreach ($slides as $index => $slide): ?>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                     ...
                     <input type="text" id="slide_head_tag_<?php echo esc_attr($index); ?>" name="slide_head_tags[]"
                         value="<?php echo esc_attr($slide['head_tag']); ?>" class="form-control" placeholder="Enter head tag" />
                 </div>
    ...
    <!-- slider end -->
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" id="slide_mini_title_0" name="slide_mini_titles[]" class="form-control"
                    value="<?php echo esc_attr($static_settings['mini_titles'][0] ?? ''); ?>" placeholder="Enter mini title" />
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <textarea id="slide_mini_description_0" name="slide_mini_descriptions[]" rows="2"
                    class="form-control" placeholder="Enter mini description"><?php echo esc_textarea($static_settings['mini_descriptions'][0] ?? ''); ?></textarea>
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" id="slide_mini_title2_0" name="slide_mini_title2[]" class="form-control"
                    value="<?php echo esc_attr($static_settings['mini_title2'][0] ?? ''); ?>" placeholder="Enter mini title 2" />
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <textarea id="slide_mini_description2_0" name="slide_mini_description2[]" rows="2"
                    class="form-control" placeholder="Enter mini description 2"><?php echo esc_textarea($static_settings['mini_description2'][0] ?? ''); ?></textarea>
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="email" id="slide_email" name="slide_email" class="form-control"
                    value="<?php echo esc_attr(isset($static_settings['slide_email']) ? $static_settings['slide_email'] : ''); ?>" placeholder="Enter email" />
            </div>
            
            <div class="form-group col-md-6">
                <label for="slide_no">Contact:</label>
                <input type="tel" id="slide_no" name="slide_no" class="form-control"
                    value="<?php echo esc_attr(isset($static_settings['slide_no']) ? $static_settings['slide_no'] : ''); ?>" placeholder="Enter contact number" />
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4"> 
                ...
                <input type="number" id="slide_email_font_size" name="slide_email_font_size" class="form-control" 
            ...
            <div class="form-group col-md-4"> 
                ...
                <input type="number" id="slide_no_font_size" name="slide_no_font_size" class="form-control" 
           ...
           <div class="form-group col-md-4 mini"> 
              ...
              <input type="number" id="ov_social_text_font_size" name="ov_social_text_font_size" class="form-control" 
