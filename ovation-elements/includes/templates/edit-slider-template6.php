...
?>
 ...
 <div id="ovs-edit-page" class="plugin_output_content">
    ...
    <div class="logo_review_btn">
        ...
        <div class="review">
         <a href="<?php echo esc_url('https://wordpress.org/support/plugin/ovation-elements/'); ?>" class="ov-head-review" target="_blank" rel="noopener noreferrer">Review Now</a>
       </div>
    </div>
        ...
        <div class="row content-row">
            ...
            <div class="col-md-6">
                <div class="content text-center">
                    ...
                    The Restaurant Slider Template is a dynamic and professional design tool perfect for creating visually stunning, interactive sliders for business websites. With customizable options for images, text, and calls-to-action, it helps businesses showcase their services, portfolio, or announcements effectively.
                    </p>
                    <div class="buttons">
...
<!-- live preview -->
<div class="modal fade modal-temp-6" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <section id="oe-restaurant-slider-main-box" class="oe-restaurant-slider-main-box_restaurant" style="background-image: url('');">   
    <div id="carouselExampleIndicators" class="carousel slides carousel-fade" data-bs-ride="" data-bs-interval="1500">
                        ...
                        <div class="oe-restaurant-slider-bg-image position-relative">
                            <div class="container">                           
                                ...
                                <div class="oe-restaurant-slider-content-outer-box position-relative">
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-7 col-md-12 col-sm-12 col-12 oe-restaurant-slider-content-inner-box align-self-center">
                                            <div class="oe-restaurant-slider-banner-content-box">
                                                <div class="d-flex flex-column gap-2 oe-restaurant-slider-banner-content-main">
                                                    <div class="d-flex justify-content-md-start justify-content-sm-center justify-content-center align-items-center">
                                                        <span class="oe-restaurant-slider-icon-img mr-2 me-2 ms-0 position-relative">
                                                        ...
                                                        <span class="oe-restaurant-slider-sub-head">Welcome To My Restaurant</span>
                                                    </div>
                                                    <div class="oe-restaurant-slider-banner-heading-box">
                                                        <h1 class="oe-restaurant-slider-banner-main-head">The Restaurant Holds Spices</h1>
                                                    </div>
                                                    <p class="oe-restaurant-slider-banner-sec-para">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                        
                                                    <div class="d-flex gap-md-4 gap-sm-2 gap-2 align-items-center oe-restaurant-slider-banner-btn-box pt-3">
                                                        <a class="oe-restaurant-slider-explore-btn" href="#">Explore More</a>      
                                                        <a class="oe-restaurant-slider-appointement-btn" href="#">Appointment</a>         
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row restaurant_info">
                                    ...
                                    <div class="col-xl-7 col-lg-6 col-md-6 oe-restaurant-slider-address-content-box">
                                        <div class="row oe-restaurant-slider-address-outer-box">
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-8 col-12 oe-restaurant-slider-address d-flex">
                                                <div class="oe-restaurant-slider-address-icon align-self-center">
                                                    <i class="fa-solid fa-location-dot"></i>
                                                    
                                                </div>
                                                <div class="oe-restaurant-slider-address-box ms-3">
                                                    <p class="oe-restaurant-slider-address-title">Restaurant Address</p>
                                                    <p class="oe-restaurant-slider-address-para">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                                </div>
                                            </div>

                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-8 col-12 oe-restaurant-slider-call d-flex">
                                                <div class="oe-restaurant-slider-call-icon align-self-center">
                                                    <i class="fa-solid fa-phone"></i>
                                                    <img src="">
                                                </div>
                                                <div class="oe-restaurant-slider-call-box ms-3 align-self-center">
                                                    <p class="oe-restaurant-slider-call-title">Call For Us</p>
                                                    <p class="oe-restaurant-slider-call-para">+12 3456789123</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="col-xl-1 col-lg-2 col-md-2 oe-restaurant-slider-video-content-box p-0" style="position: relative; background-size: 100% 100%; background-image: url();">

                                        <div class="oe-restaurant-slider-video-box">
                                            <a class="oe-restaurant-slider-video-btn myVideoBtns" data-url="#" href="#myModal1" id="myBtn1">
                                                <i class="fa fa-play"></i>
                                            </a>
                                        </div>
                                    </div>

                                    <div class="col-xl-4 col-lg-4 col-md-4  oe-restaurant-slider-review-content-box p-0 position-relative">
                                        <div class="oe-restaurant-slider-review-outer-box">
                                            <div class="oe-restaurant-slider-review-box d-flex">
                                                ...
                                                <div class="oe-restaurant-slider-review-text">
                                                    <p class="oe-restaurant-slider-review-count">05k+</p>
                                                    <p class="oe-restaurant-slider-review-count-text">Tourist Review</p>
                                                </div>
                                            </div>

                                            <div class="oe-restaurant-slider-special-box">
                                                <p class="oe-restaurant-slider-special-title">Daily Specials</p>
                                                <p class="oe-restaurant-slider-special-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
...
<div class="tabs_buttons_outer">
    <ul class="nav nav-tabs" id="settingsTabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="free-tab" data-toggle="tab" href="#free-settings" role="tab" aria-controls="free-settings" aria-selected="true">Content</a>
        </li>
        <li class="nav-item">
        <a class="nav-link" id="advanced-tab" data-toggle="tab" href="#advanced-settings" role="tab" aria-controls="advanced-settings" aria-selected="false">
        ...
        <div id="slider-slides">
                ...
                <div class="slide-container mb-4 p-3 border rounded" data-index="0">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" id="slide_title_0" name="slide_titles[]" class="form-control" placeholder="Enter slide title" />
                        </div>
                        <div class="form-group col-md-12">
                            <label for="slide_description_0">Description:</label>
                            <textarea id="slide_description_0" name="slide_descriptions[]" rows="3" class="form-control" placeholder="Enter slide description"></textarea>
                        </div>
                        <!-- New Mini Head Tag Image Setting -->
                        <div class="form-group col-md-6 d-flex align-items-center">
                            <label for="slide_mini_head_image_0">Mini Head Tag Image:</label>
                            <input type="hidden" id="slide_mini_head_image_0" name="slide_mini_head_images[]" />
                            <img src="" id="mini_head_image_preview_0" style="max-width: 100px; max-height: 100px; display: none;" />
                        ...
                        <div class="form-group col-md-6"> 
                            ...
                            <input type="text" id="slide_head_tag_0" name="slide_head_tags[]" class="form-control" placeholder="Enter head tag text" />
                        </div>
                        
                        <div class="form-group  col-md-6 halfs">
                            <label for="slide_button_text_0">Button Text:</label>
                            <input type="text" id="slide_button_text_0" name="slide_button_texts[]" class="form-control" placeholder="Enter button text" />
                        </div>
                        <div class="form-group col-md-6 halfs">
                            <label for="slide_button_url_0">Button URL:</label>
                            <input type="url" id="slide_button_url_0" name="slide_button_urls[]" class="form-control" placeholder="Enter button URL" />
                        </div>
                        
                        <div class="form-group col-md-6 halfs">
                            <label for="slide_button2_text_0">Button Text 2:</label>
                            <input type="text" id="slide_button2_text_0" name="slide_button2_texts[]" class="form-control" placeholder="Enter second button text" />
                        </div>
                        <div class="form-group col-md-6 halfs">
                            <label for="slide_button2_url_0">Button URL 2:</label>
                            <input type="url" id="slide_button2_url_0" name="slide_button2_urls[]" class="form-control" placeholder="Enter second button URL" />
                        </div>
            ...
            <?php foreach ($slides as $index => $slide): ?>
                ...
                <div class="form-group col-md-12">
                     ...
                     <label for="slide_bg_color_<?php echo esc_attr($index); ?>">Background Color:</label>
                     <input type="color" id="slide_bg_color_<?php echo esc_attr($index); ?>" name="slide_bg_color[]" value="<?php echo esc_attr($slide['slide_bg_color'] ); ?>"/>
                 </div>
                 <div class="form-group col-md-12">
                     ...
                     <input type="text" id="slide_title_<?php echo esc_attr($index); ?>" name="slide_titles[]"
                            value="<?php echo esc_attr($slide['title']); ?>" class="form-control" placeholder="Enter slide title" />
                 </div>
                 ...
                 <div class="form-group col-md-12">
                     ...
                     <textarea id="slide_description_<?php echo esc_attr($index); ?>" name="slide_descriptions[]" rows="3"
                               class="form-control" placeholder="Enter slide description"><?php echo esc_textarea($slide['description']); ?></textarea>
                 </div>
                 
                 <div class="form-group col-md-6">
                     <label for="slide_head_tag_<?php echo esc_attr($index); ?>">Head Tag</label>
                     <input type="text" id="slide_head_tag_<?php echo esc_attr($index); ?>" name="slide_head_tags[]" value="<?php echo esc_attr($slide['head_tag']); ?>" class="form-control" placeholder="Enter head tag" />
                 </div>
                 
                 <!-- New Mini Head Tag Image Setting -->
                 <div class="form-group col-md-6 d-flex align-items-center">
                     <label for="slide_mini_head_image_<?php echo esc_attr($index); ?>">Mini Head Tag Image:</label>
                     <input type="hidden" id="slide_mini_head_image_<?php echo esc_attr($index); ?>" name="slide_mini_head_images[]"
                     ...
                     <button type="button" class="minihead_upload_image_button button btn btn-primary mt-2">Upload Mini Head Tag Image</button>
                 </div>
                 ...
                 <div class="form-group col-md-6 halfs">
                     ...
                     <input type="text" id="slide_button_text_<?php echo esc_attr($index); ?>" name="slide_button_texts[]"
                            value="<?php echo esc_attr($slide['button_text']); ?>" class="form-control" placeholder="Enter button text" />
                 </div>
                 <div class="form-group col-md-6 halfs">
                     ...
                     <input type="url" id="slide_button_url_<?php echo esc_attr($index); ?>" name="slide_button_urls[]"
                            value="<?php echo esc_url($slide['button_url']); ?>" class="form-control" placeholder="Enter button URL" />
                 </div>
                 <!-- add -->
                 <div class="form-group col-md-6 halfs">
                     <label for="slide_button2_text_<?php echo esc_attr($index); ?>">Button Text 2:</label>
                     <input type="text" id="slide_button2_text_<?php echo esc_attr($index); ?>" name="slide_button2_texts[]"
                            value="<?php echo esc_attr($slide['button2_text']); ?>" class="form-control" placeholder="Enter button text 2" />
                 </div>
                 <div class="form-group col-md-6 halfs">
                     <label for="slide_button2_url_<?php echo esc_attr($index); ?>">Button URL 2:</label>
                     <input type="url" id="slide_button2_url_<?php echo esc_attr($index); ?>" name="slide_button2_urls[]"
                            value="<?php echo esc_url($slide['button2_url']); ?>" class="form-control" placeholder="Enter button URL 2" />
                 </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="slide_mini_title_0" name="slide_mini_titles[]" class="form-control"
                        value="<?php echo esc_attr($static_settings['mini_titles'][0] ?? ''); ?>" placeholder="Enter heading (location, address)" />
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea id="slide_mini_description_0" name="slide_mini_descriptions[]" rows="2"
                            class="form-control" placeholder="Enter full address"><?php echo esc_textarea($static_settings['mini_descriptions'][0] ?? ''); ?></textarea>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="slide_mini_title2_0" name="slide_mini_title2[]" class="form-control"
                        value="<?php echo esc_attr($static_settings['mini_title2'][0] ?? ''); ?>" placeholder="Enter heading (Contact, Dial)" />
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="slide_no" name="slide_no" class="form-control"
                        ...
                        pattern="\d+" title="Only numbers are allowed" placeholder="Enter contact number" />
                </div>
                <!-- details clsoe -->
                ...
                <div class="form-group  col-md-4 mini d-flex align-items-center gap-3 mt-3">
                    ...
                    <button type="button" id="ov-imp-client" class="upload_corner_images_button button upload_image_button">Upload
                        Image</button>
                </div>
                <!-- New Settings Start -->
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" id="ov_template_review_no" name="ov_template_review_no" class="form-control" 
                ...
                <div class="form-group col-md-6 mt-3">
                    ...
                    <textarea id="list_description" name="list_description" 
                ...
                <div class="form-group col-md-6 mt-3">
                    ...
                    <input type="text" id="enter_list" name="enter_list" 
                            ...
                            class="regular-text" placeholder="e.g., BBQ Ribs, Grilled Salmon, Cavatappi Pasta" />
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <video id="uploaded_video_preview" controls style="max-width: 20%; margin-top: 10px; display: <?php echo empty($static_settings['slide_video_url']) ? 'none' : 'block'; ?>;">
                        <source src="<?php echo esc_url($static_settings['slide_video_url'] ?? ''); ?>" type="video/mp4">
                ...
                <div class="form-group col-md-6 mt-3">
                    ...
                    <div id="video_bg_preview" style="margin-top:10px;">
                        <?php if (!empty($static_settings['video_bg_image'])): ?>
                            <img src="<?php echo esc_url($static_settings['video_bg_image']); ?>" width="100" height="auto">
                        <?php endif; ?>
                    </div>
                </div>
           ...
           <!-- new settings -->
                <div class="form-group col-md-6"> 
                 ...
                 <div class="form-group col-md-6"> 
                    ...
                    <input type="number" id="heading_font_size" name="heading_font_size" class="form-control" 
                 ...
                 <div class="form-group col-md-6"> 
                      ...
                      <input type="number" id="banner_font_size" name="banner_font_size" class="form-control" 
                ...
                <div class="form-group col-md-6"> 
                      ...
                      <input type="number" id="button_font_size" name="button_font_size" class="form-control" 
                ...
                <div class="form-group col-md-6">
                      ...
                      <input type="number" id="ov_mini_title_font_size" name="ov_mini_title_font_size" class="form-control"
                             value="<?php echo esc_attr(isset($static_settings['ov_mini_title_font_size']) ? $static_settings['ov_mini_title_font_size'] : '18'); ?>" />
                </div>
     
                <div class="form-group col-md-6"> 
                     <label for="mini_description_font_size">(address / contact) content Font Size</label>
                     <input type="number" id="mini_description_font_size" name="mini_description_font_size" class="form-control" 
                ...
                <div class="form-group col-md-6">
                      ...
                      <input type="number" id="list_title_font_size" name="list_title_font_size" class="form-control" 
                ...
                <div class="form-group col-md-6">
                      ...
                      <input type="number" id="list_description_font_size" name="list_description_font_size" class="form-control" 
                ...
                <div class="form-group col-md-6">
                      ...
                      <input type="number" id="list_content_font_size" name="list_content_font_size" class="form-control" 
                ...
                <div class="form-group col-md-6">
                      ...
                      <input type="number" id="review_text_font_size" name="review_text_font_size" class="form-control" 
                ...
                <div class="form-group col-md-6">
                      ...
                      <input type="number" id="review_no_font_size" name="review_no_font_size" class="form-control" 
      ...
      <!-- Advanced Settings Tab -->
        ...
        <div class="row">
                     ...
                     <div class="col-md-4 mb-4 form-group">
                         ...
                         <input type="text" id="button_hover_bg_color" name="button_hover_bg_color" class="form-control" 
                     ...
                     <div class="col-md-4 mb-4 form-group">
                         ...
                         <input type="text" id="button_hover_text_color" name="button_hover_text_color" class="form-control" 
