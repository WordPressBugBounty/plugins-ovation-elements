...
// Fetch courses and prepare data
...
<?php
// Check if the Tutor plugin is installed and activated
...
// Button label and action based on plugin status
        ...
        <div class="row content-row">
            ...
            <div class="col-md-6">
                <div class="content text-center">
                    ...
                    The Education Slider Template is a dynamic and professional design tool perfect for creating visually stunning, interactive sliders for business websites. With customizable options for images, text, and calls-to-action, it helps businesses showcase their services, portfolio, or announcements effectively.
                    </p>
                    <div class="buttons">
...
<!-- Modal -->
<div class="modal fade modal-temp-8" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="oe-education-slider-bg-image e-education-slider-bg-image_edu position-relative" style="background:url('<?php echo esc_url($bg_image); ?>')">
    ...
    <div class="container"> 
        ...
        <div class="oe-education-slider-content-outer-box position-relative">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12 col-12 oe-education-slider-content-inner-box align-self-center">
                    <div class="oe-education-slider-banner-content-box">
                        <div class="d-flex flex-column gap-2 oe-education-slider-banner-content-main">
                            ...
                            <div class="d-flex justify-content-md-start justify-content-sm-center justify-content-center align-items-center">                     
                                <span class="oe-education-slider-sub-head">Welcome Educate Theme</span>
                            </div>
                            ...
                            <div class="row oe-education-slider-banner-points">
                                ...
                                <div class="col-lg-6">
                                    <i class="fa fa-check me-3"></i><span class="oe-education-slider-banner-point-text">Expert Adviser</span>
                                </div>
                                <div class="col-lg-6">
                                    <i class="fa fa-check me-3"></i><span class="oe-education-slider-banner-point-text">Global thinkers.</span>
                                </div>
                                <div class="col-lg-12">
                                    <i class="fa fa-check me-3"></i><span class="oe-education-slider-banner-point-text">Collaborative Learning Environment</span>
                                </div>
                            </div>

                            <!-- Buttons -->
                            <div class="d-flex gap-md-4 gap-sm-2 gap-2 align-items-center oe-education-slider-banner-btn-box pt-3">
                                <a class="oe-education-slider-explore-btn" href="#">Explore More</a>      
                                <a class="oe-education-slider-appointement-btn" href="#">Get Quote</a>         
                            </div>
                        </div>
                    </div>
                </div> 
                ...
                <div class="col-xl-4 col-lg-7 col-md-6 oe-education-slider-banner-box">
                    <div class="oe-education-slider-post-box">
                        <img src="<?php echo esc_url(OVA_ELEMS_URL . 'assets/images/ov-slide8-post-img.png'); ?>" alt="">
                        <div class="oe-education-slider-post-content-box">
                            ...
                            <div class="oe-education-slider-post-author-box d-flex" style="justify-content:space-between;">
                                <div>
                                    <span>
            ...
            <div class="row slider_bottom_edu" style="margin-top: 0px;">
                ...
                <div class="col-xl-4 col-lg-3 col-md-12 col-sm-12 col-12 oe-education-slider-content-inner-box align-self-center"></div>

                <!-- Video and Rating Content -->
                <div class="col-xl-8 col-lg-9 col-md-12 col-sm-12 col-12 oe-education-slider-video-rating-content-box align-self-center">
                    ...
                    <div class="row tab_row">
                        ...
                        <!-- Video Section -->
                        <div class="col-lg-2 col-md-4    oe-education-slider-video-content-box position-relative">
                            <div class="oe-education-slider-video-image-box" 
                                 style="background-image: url();">
                                <a class="oe-education-slider-video-icon-box myVideoBtns" data-url="#" href="#myModal1" id="myBtn1">
                        ...
                        <div class="oe-education-slider-followers-content-box col-lg-5 col-md-4 d-flex">            
...
<div id="install-activate-tutor" class="plugin_output_content">
    ...
    <p id="plugin-activation-message" class="plugin-activation-message">
        Please activate the Tutor LMS plugin to Add Courses In Slides. After Activating the Tutor LMS plugin, you have to create courses.
    </p>
    ...
    <button 
        ...
        <?php echo isset($button_disabled) ? 'disabled' : ''; ?>>
            ...
            <?php if (empty($slides)): ?>
                <div class="slide-container mb-4 p-3 border rounded" data-index="0">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="slide_title_0" name="slide_titles[]" class="form-control" required placeholder="Enter the title "/>
                    </div>
            ...
            <?php foreach ($slides as $index => $slide): ?>
                ...
                <h3>Slide <?php echo esc_html($index + 1); ?></h3>
                    ...
                    <input type="text" id="slide_title_<?php echo esc_attr($index); ?>" name="slide_titles[]"
                            value="<?php echo esc_attr($slide['title']); ?>" class="form-control" required placeholder="Enter the title "/>
                    </div>

                    <div class="form-group">
                        <label for="slide_course_<?php echo esc_attr($index); ?>">Select Course:</label>
                        <select id="slide_course_<?php echo esc_attr($index); ?>" name="slide_courses[]" class="form-control">
                            <option value="">Select a course</option>
                            <?php 
                            $courses = get_posts(['post_type' => 'courses', 'numberposts' => -1]);
                            foreach ($courses as $course): ?>
                                <option value="<?php echo esc_attr($course->ID); ?>" 
                                    <?php selected($slide['course_id'] ?? '', $course->ID); ?>>
                                    <?php echo esc_html($course->post_title); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
        ...
        <!-- slider end -->
            <div class="row">
                ...
                <div class="form-group mini d-flex gap-3">
                    ...
                    <button type="button"
                        class="upload_mini_image_1_button button mt-2 upload_image_button">Upload Image</button>
                </div>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" id="slide_mini_title_0" name="slide_mini_titles[]" class="form-control"
                        value="<?php echo esc_attr($static_settings['mini_titles'][0] ?? ''); ?>" placeholder="Enter heading" />
                </div>
                <!-- new add for review -->
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" id="slide_mini_title2_0" name="slide_mini_title2[]" class="form-control"
                        value="<?php echo esc_attr($static_settings['mini_title2'][0] ?? ''); ?>" placeholder="Enter mini head tittle" />
                </div>
                ...
                <div class="col-md-6 form-group d-flex align-items-center">
                    ...
                    <button type="button" class="upload_video_button button upload_image_button">Upload Video</button>
                </div>
                ...
                <div class="col-md-6 form-group mt-3">
                    ...
                    <input type="number" id="static_loader_percentage" name="static_loader_percentage" 
                        value="<?php echo esc_attr($static_settings['static_loader_percentage'] ?? '90'); ?>" 
                        min="0" max="100" step="1" class="form-control" placeholder="Enter loader percentage" />
                </div>
                ...
                <div class="form-group col-md-6">
                     ...
                     <?php if (!empty($static_settings['bg_slide_image'])) : ?>
                         <div class="preview-bg-slide-image" style="margin-top: 10px;">
                             <img src="<?php echo esc_url($static_settings['bg_slide_image']); ?>" alt="Background Image" style="max-width: 150px; height: auto; border: 1px solid #ddd; padding: 5px;">
                         </div>
                     <?php endif; ?>
                 </div>
              ...
              <!-- new settings -->
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="number" id="static_button_text_font_size" name="static_button_text_font_size" class="form-control"
