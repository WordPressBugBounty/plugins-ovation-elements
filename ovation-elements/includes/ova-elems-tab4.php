<body>
    ...
    <p class="coming-soon-text">
        <?php echo esc_html__('Our custom page builder feature is under development and will provide you with powerful options for designing unique pages. Check back soon!.', 'ovation-elements'); ?>
    </p>
